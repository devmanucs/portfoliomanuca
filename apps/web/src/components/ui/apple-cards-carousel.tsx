    ...
    <>
      <AnimatePresence>
        {open && (
          <div className="fixed inset-0 z-50 h-screen overflow-auto">
            ...
            >
              <button
                className="sticky top-4 right-0 ml-auto flex h-8 w-8 items-center justify-center rounded-full bg-muted"
                onClick={handleClose}
                aria-label="Fechar"
              >
                <X className="h-6 w-6 text-foreground" />
              </button>
              <p className="text-base font-medium text-sage">{card.category}</p>
              <p className="mt-4 text-2xl font-semibold text-foreground md:text-5xl">
                {card.title}
              </p>
      ...
      >
        ...
        <div className="relative z-40 p-8">
          <p className="max-w-xs text-left font-sans text-sm font-medium text-white md:text-base">
            {card.category}
          </p>
