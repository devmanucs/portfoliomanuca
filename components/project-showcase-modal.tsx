...
import {
  ProjectCardContent,
  ProjectModalActions,
} from "@/components/project-card-content";
      ...
      {project ? (
        ...
        >
          ...
          <motion.div
            ...
            className="relative z-10 flex max-h-[min(88vh,820px)] w-full max-w-3xl flex-col overflow-hidden rounded-2xl border border-border bg-card shadow-2xl md:max-w-4xl"
